    ...
    <>
      ...
      <section style={{ backgroundColor: 'var(--gray-900)' }}>
        <div className="grid-half">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: 'clamp(2rem, 5vw, 4rem)', maxWidth: '600px' }}>
            ...
            <Link href="/shop/the-ascent-tee" className="btn" style={{ alignSelf: 'flex-start' }}>
              EXPLORE THE PIECE
            </Link>
          </div>
        </div>
